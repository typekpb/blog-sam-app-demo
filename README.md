...
The application demonstrating SAM-based AWS Lambda development with Localstack.
For details, see the respective blog post.

# sam-app-demo (SAM cli) generated docs
